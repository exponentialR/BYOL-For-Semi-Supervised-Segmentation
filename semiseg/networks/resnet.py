...
model_urls = {
    'resnet18': 'https://download.pytorch.org/models/resnet-5c106cde.pth',
...
def _build_model(resnet_type: str = 'resnet50', pretrained: bool = False,
    ...
    :param resnet_type: such as 'resnet50' 'resnet50' etc
    :param pretrained: True if the network is expected to be initialized with pretrained imagenet weights
    :param replace_stride_with_dilation: list of 3 bool values if the last 3 blocks of the resnet should use dilation instead of stride
    ...
    if resnet_type == 'resnet18':
        ...
        print(f'resnet type {resnet_type} is not currently implemented')
        return
    ...
    network.isDRN = any(replace_stride_with_dilation)
