...
def get_num_features(backbone_name: str, model_type: str = '') -> List:
    """
    Gives a Listof features present in the last blocks of the backbone model
    :param backbone_name: name of the backbone model e.g. 'resnet18' or resnet50
    :param model_type: type of FCN model (fcn32s, fcn16s, fcn8s)
    :return: List of number of features extracted from the last 3 blocks of the backbone model
    """
